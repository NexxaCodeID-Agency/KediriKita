...
export default function CardSection() {
  return (
    ...
    >
      ...
      {/* Floating 3D Cards di kanan — hidden on mobile */}
      ...
      <div className="relative z-10 h-full flex items-center justify-center md:justify-start px-4 md:px-0 md:pl-10 lg:pl-24" style={{ paddingTop: "5vh" }}>
        {/* Card wrapper */}
