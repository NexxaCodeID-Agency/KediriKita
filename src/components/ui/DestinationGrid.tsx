...
const CATEGORIES = ["Semua", "Alam", "Kuliner", "Sejarah", "Budaya"];
    ...
    <section className="min-h-screen px-6 pt-10 pb-24 max-w-7xl mx-auto">
      ...
      <div className="text-center mb-12">
        ...
        <p
          ...
          style={{ color: "rgba(255,255,255,0.55)", fontFamily: "var(--font-lato)" }}
        >
        ...
        {CATEGORIES.map((cat) => (
          <button
            ...
            style={{
              ...
              color: activeCategory === cat ? "#1A1A2E" : "rgba(255,255,255,0.6)",
              border:
                activeCategory === cat
      ...
      {filtered.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-32 gap-4">
          <p
            className="text-lg"
            style={{ color: "rgba(255,255,255,0.35)", fontFamily: "var(--font-lato)" }}
          >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {filtered.map((item) => (
            <Link href={`/destinasi/${item.slug}`} key={item.id} className="group block">
              <div
